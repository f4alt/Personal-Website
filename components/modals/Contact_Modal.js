  ...
  return (
      ...
      {props.open ? (
        <>
          ...
          >
            <div onKeyPress={(target) => {console.log("HERE"); if (target.charCode === ESC_KEY) {console.log("click")}}}className={`${Fullscreen ? "fullscreen" : ""} relative w-auto mx-auto max-w-3xl`}>
              {/*content*/}
              ...
              >
                ...
                <div className="grid">
                  ...
                  <div className={`${Fullscreen ? "fullscreen-text" : ""} px-6 py-4`}>
                    <p className={`${Fullscreen ? "fullscreen-text" : ""} text-2xl`}>Want to reach out?</p>
